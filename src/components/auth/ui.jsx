    ...
    <label className="block">
      ...
      <span className="relative block">
        ...
        <input
          ...
          className={`w-full rounded-xl border bg-[#0a1122] py-3 text-sm text-white placeholder-zinc-600 outline-none transition-all duration-200 ${
            icon ? "pl-10" : "pl-4"
          } ${right ? "pr-12" : "pr-4"} ${
            error
              ? "border-rose-600/70 shadow-[0_0_0_3px_rgba(255,255,255,0.14),0_0_18px_rgba(255,255,255,0.25)] focus:border-rose-500"
    ...
    <label className="block">
      ...
      <span className="relative block">
        <select
          ...
          onChange={onChange}
          aria-invalid={Boolean(error)}
          className={`w-full cursor-pointer appearance-none rounded-xl border bg-[#0a1122] py-3 pl-4 pr-10 text-sm outline-none transition-all duration-200 ${
            value
              ? "text-white"
              : "text-zinc-600"
          } ${
            error
              ? "border-rose-600/70 shadow-[0_0_0_3px_rgba(255,255,255,0.14),0_0_18px_rgba(255,255,255,0.25)]"
              : "border-line focus:border-rose-500/60 focus:shadow-[0_0_0_3px_rgba(255,255,255,0.12)]"
          }`}
        >
  ...
  return (
    <motion.div
      ...
      className={`flex items-start gap-2.5 rounded-xl border px-3.5 py-3 text-sm font-medium ${
        isError
          ? "border-rose-600/50 bg-rose-500/[0.08] text-rose-300 shadow-[0_0_22px_rgba(255,255,255,0.2)]"
  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      <button
        type="button"
        onClick={onGitHub}
        className="flex items-center justify-center gap-2.5 rounded-xl border border-line bg-white/[0.03] px-4 py-3 text-sm font-semibold text-zinc-300 transition-all duration-200 hover:border-rose-500/40 hover:bg-rose-500/[0.06] hover:text-white hover:shadow-[0_0_18px_rgba(255,255,255,0.25)]"
      >
