...
export default function CampaignPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 flex-1 w-full">
      ...
      <div className="border border-emerald-500/30 rounded-lg bg-emerald-500/10 p-6 mb-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="rounded-lg border border-line bg-panel p-5">
          <h3 className="font-semibold text-white mb-1">Volunteer</h3>
          <p className="text-sm text-zinc-400">
            Join a ward or LGA team and help with canvassing and rallies.
          </p>
        </div>
        <div className="rounded-lg border border-line bg-panel p-5">
          <h3 className="font-semibold text-white mb-1">Donate</h3>
          <p className="text-sm text-zinc-400">
