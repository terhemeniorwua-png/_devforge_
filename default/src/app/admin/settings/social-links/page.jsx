  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10 flex-1 w-full">
      ...
      <form
        ...
        className="bg-panel rounded-lg border border-line p-6 space-y-5"
      >
        {FIELDS.map((field) => (
          <div key={field.key}>
            <label
            ...
            <input
              ...
              className="w-full rounded-md border border-line bg-[#0a1122] px-3 py-2 text-sm text-zinc-100 placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-transparent"
            />
            {field.hint && (
      ...
      <div className="mt-8 rounded-lg border border-line bg-white/[0.02] p-5">
        ...
        <p className="text-sm text-zinc-400 mb-3">
          ...
          {whatsappPreview ? (
            ...
            <span className="text-zinc-500">set a number to preview</span>
          )}
        </p>
      </div>
    </div>
