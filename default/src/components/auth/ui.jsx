      ...
      <span className="relative block">
        ...
        <input
          ...
          className={`w-full rounded-xl border bg-[#0a1122] py-3 text-sm text-white placeholder-zinc-600 outline-none transition-all duration-200 ${
            ...
            error
              ? "border-rose-600/70 shadow-[0_0_0_3px_rgba(255,255,255,0.14)] focus:border-rose-500"
      ...
      <span className="relative block">
        <select
          ...
          className={`w-full cursor-pointer appearance-none rounded-xl border bg-[#0a1122] py-3 pl-4 pr-10 text-sm outline-none transition-all duration-200 ${
            ...
            error
              ? "border-rose-600/70 shadow-[0_0_0_3px_rgba(255,255,255,0.14)]"
              : "border-line focus:border-rose-500/60 focus:shadow-[0_0_0_3px_rgba(255,255,255,0.12)]"
          }`}
        >
...
export function SubmitButton({ children, loading, disabled }) {
  return (
    <button
      ...
      className="group flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-red-500 via-rose-600 to-red-800 px-5 py-3.5 text-sm font-semibold text-obsidian transition-all duration-300 disabled:cursor-not-allowed disabled:opacity-60"
    >
      {loading ? (
  ...
  return (
    <motion.div
      ...
      className={`flex items-start gap-2.5 rounded-xl border px-3.5 py-3 text-sm font-medium ${
        isError
          ? "border-rose-600/50 bg-rose-500/[0.08] text-rose-300"
  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      <button
        type="button"
        onClick={onGitHub}
        className="flex items-center justify-center gap-2.5 rounded-xl border border-line bg-white/[0.03] px-4 py-3 text-sm font-semibold text-zinc-300 transition-all duration-200 hover:border-rose-500/40 hover:bg-rose-500/[0.06] hover:text-white"
      >
