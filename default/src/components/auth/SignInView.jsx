    ...
    return (
      ...
      >
        <div className="relative">
          ...
          <div className="relative grid h-20 w-20 place-items-center rounded-2xl border border-rose-500/40 bg-gradient-to-br from-red-500/20 via-rose-600/15 to-red-900/20 font-mono text-2xl font-extrabold text-rose-300">
            {initials}
          </div>
        </div>
        ...
        <div className="mt-7 grid w-full grid-cols-2 gap-3">
          <Link
            href={dashboardHref}
            className="flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-red-500 via-rose-600 to-red-800 px-4 py-3 text-sm font-semibold text-obsidian transition-all"
          >
            <Play size={15} />
            Continue Learning
          </Link>
