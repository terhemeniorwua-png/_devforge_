...
function CodeBlock({ code }) {
  return (
    <pre className="overflow-x-auto rounded-xl border border-line bg-[#0a1122] p-4 font-mono text-[13px] leading-relaxed text-zinc-300">
...
function OptionButton({ option, state, onClick, disabled, optionIndex }) {
  ...
  if (state === "correct") {
    ...
    marker = (
      <span className="grid h-5 w-5 shrink-0 place-items-center rounded-full bg-emerald-500 text-[#000000]">
    ...
    classes =
      base +
      " border-red-600/70 bg-red-600/10 text-red-200";
    marker = (
...
export default function QuizHub() {
  ...
  return (
    <section className="relative overflow-hidden">
      <div className="pointer-events-none absolute -left-40 top-40 h-[460px] w-[460px] rounded-full radial-red blur-2xl" />
      <div className="pointer-events-none absolute -right-40 bottom-24 h-[400px] w-[400px] rounded-full radial-crimson blur-2xl" />
          ...
          <AnimatePresence mode="wait">
            {view === "select" && (
              <motion.div
                ...
                className="mx-auto max-w-3xl rounded-3xl border border-line bg-panel/80 p-6 backdrop-blur sm:p-10"
              >
                <div className="flex flex-col items-center text-center">
                  <span className="grid h-14 w-14 place-items-center rounded-2xl bg-gradient-to-br from-red-500 via-rose-600 to-red-900">
                ...
                <button
                  ...
                  className="group mt-8 flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-red-500 via-rose-600 to-red-800 px-6 py-4 text-base font-bold text-obsidian transition-all"
                >
            ...
            {view === "play" && current && (
              ...
              >
                ...
                <div className="mt-6 rounded-3xl border border-line bg-panel/80 p-6 backdrop-blur sm:p-8">
                    ...
                    {answered && (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-red-500 via-rose-600 to-red-800 px-5 py-3 text-sm font-bold text-obsidian transition-all"
                        >
            ...
            {view === "results" && (
              ...
              >
                <div className="flex flex-col items-center text-center">
                  <span className="grid h-16 w-16 place-items-center rounded-2xl bg-gradient-to-br from-red-500 via-rose-600 to-red-900">
                ...
                <div className="mt-8 grid gap-3 sm:grid-cols-2">
                  ...
                  <button
                    type="button"
                    onClick={retake}
                    className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-red-500 via-rose-600 to-red-800 px-6 py-3.5 text-sm font-bold text-obsidian transition-all"
                  >
                    <RotateCcw size={16} />
