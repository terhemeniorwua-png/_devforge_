      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <Reveal>
          <div className="shimmer-border relative overflow-hidden rounded-3xl border border-line bg-panel px-6 py-16 text-center sm:px-16">
            <div className="pointer-events-none absolute -top-32 left-1/2 h-72 w-[600px] -translate-x-1/2 rounded-full radial-red blur-2xl" />
            ...
            <div className="relative">
              ...
              <div className="mt-9 flex flex-wrap items-center justify-center gap-4">
                <Link
                  href="/catalog"
                  className="group inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-red-500 via-rose-600 to-red-800 px-7 py-3.5 text-base font-semibold text-obsidian transition-all"
                >
                  Start Learning Free
                ...
                <Link
                  href="/onboarding"
                  className="group inline-flex items-center gap-2 rounded-xl border border-amber-500/40 bg-amber-500/5 px-7 py-3.5 text-base font-semibold text-amber-300 transition-all hover:border-amber-400/70 hover:bg-amber-500/10"
                >
                  Get 1-on-1 Guidance
                  <ArrowRight size={18} className="transition-transform group-hover:translate-x-1" />
                </Link>
