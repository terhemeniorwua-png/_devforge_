    ...
    <div className="relative">
      <div className="overflow-hidden rounded-2xl border border-line bg-panel">
        ...
        <div className="relative">
          ...
          <div className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 rounded-lg border border-rose-500/30 bg-[#0a1122]/80 px-3 py-2 font-mono text-xs text-zinc-300 backdrop-blur-sm">
      ...
      >
        <div className="animate-float rounded-xl border border-line bg-panel/95 px-4 py-3 backdrop-blur">
      ...
      >
        <div
          className="animate-float rounded-xl border border-line bg-panel/95 px-4 py-3 backdrop-blur"
...
export default function Hero() {
  return (
    <section className="relative overflow-hidden pb-24 pt-16 sm:pt-24">
      ...
      <div className="pointer-events-none absolute -top-40 left-1/2 h-[480px] w-[820px] -translate-x-1/2 rounded-full radial-red blur-2xl" />
      <div className="pointer-events-none absolute -bottom-48 -right-32 h-[420px] w-[420px] rounded-full radial-crimson blur-2xl" />
      ...
      <div className="relative mx-auto grid max-w-7xl items-start gap-16 px-4 sm:px-6 lg:grid-cols-[1.05fr_1fr] lg:gap-10 lg:px-8">
        <div className="flex flex-col items-start">
          ...
          <Reveal delay={320} className="mt-9 flex w-full flex-wrap items-center justify-between gap-3">
            <Link
              href="/catalog"
              className="group inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-red-500 via-rose-600 to-red-800 px-6 py-3.5 text-base font-semibold text-obsidian transition-all"
            >
              Explore Courses
            ...
            <Link
              href="/vault"
              className="group inline-flex items-center justify-center gap-2 rounded-xl border border-rose-500/40 bg-rose-500/5 px-6 py-3.5 text-base font-semibold text-rose-300 transition-all hover:border-rose-400/70 hover:bg-rose-500/10"
            >
            ...
            <Link
              href="/onboarding"
              className="group inline-flex items-center justify-center gap-2 rounded-xl border border-amber-500/40 bg-amber-500/5 px-6 py-3.5 text-base font-semibold text-amber-300 transition-all hover:border-amber-400/70 hover:bg-amber-500/10"
            >
              Get 1-on-1 Guidance
