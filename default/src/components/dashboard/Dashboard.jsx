  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed bottom-6 right-6 z-[80] max-w-sm border border-rose-500/40 bg-panel/95 p-4 backdrop-blur"
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="flex flex-col items-start justify-between gap-5 lg:flex-row lg:items-center">
          <div className="flex items-center gap-4">
            ...
            <div data-shift-student="identity">
              ...
              <div className="mt-2 flex flex-wrap items-center gap-2">
                <span className="rounded-full bg-rose-500/10 px-3 py-1 font-mono text-[11px] font-bold uppercase tracking-widest text-rose-400 ring-1 ring-rose-500/30">
                  {rank}
                </span>
                {user.isPaid && (
          ...
          <button
            ...
            className="group inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-red-500 via-rose-600 to-red-800 px-5 py-3 text-sm font-bold text-obsidian transition-all"
          >
