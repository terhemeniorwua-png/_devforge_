    ...
    >
      ...
      <div
        className={`max-w-[85%] rounded-2xl px-4 py-3 ${
          message.role === "user"
            ? "rounded-br-sm bg-gradient-to-r from-red-600 to-rose-700 text-obsidian"
...
export default function ForgeAiPanel() {
  ...
  return (
    <section
      className="overflow-hidden rounded-3xl border border-line bg-panel/70 backdrop-blur"
      data-shift-forgeai="panel"
    >
      <div className="flex items-center justify-between border-b border-line bg-[#0e1629] px-4 py-3">
        <div className="flex items-center gap-2.5">
          <span className="relative grid h-8 w-8 place-items-center rounded-lg bg-gradient-to-br from-red-500 via-rose-600 to-red-900">
      ...
      <div className="border-t border-line p-3">
        ...
        >
          ...
          <button
            ...
            className="grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-gradient-to-r from-red-500 via-rose-600 to-red-800 text-obsidian transition-all disabled:cursor-wait disabled:opacity-50"
          >
            <Send size={15} />
          </button>
        </form>
