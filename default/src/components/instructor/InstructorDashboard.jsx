...
const PRIORITY_STYLES = {
  blocker: {
    ...
    badge: "border-red-500/60 bg-red-600/15 text-red-300",
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="relative w-full max-w-2xl overflow-hidden rounded-3xl border border-line bg-panel"
        >
          ...
          <form onSubmit={save} className="space-y-4 px-5 py-5">
            ...
            <div className="flex items-center justify-between gap-3 pt-2">
              ...
              <button
                type="submit"
                disabled={!canSave}
                className="group inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-red-500 via-rose-600 to-red-800 px-5 py-3 text-sm font-bold text-obsidian transition-all disabled:cursor-not-allowed disabled:opacity-40"
              >
                <Zap size={15} />
                Publish to Quiz Hub
              </button>
      ...
      <div className="relative mx-auto max-w-[1400px] px-4 py-14 sm:px-6 lg:px-8">
        <div className="flex flex-col items-start justify-between gap-6 lg:flex-row lg:items-center">
          <div className="flex items-center gap-4">
            <span className="relative grid h-16 w-16 place-items-center rounded-2xl bg-gradient-to-br from-red-500 via-rose-600 to-red-900 font-mono text-xl font-extrabold text-obsidian">
        ...
        <div className="mt-8 grid gap-6 xl:grid-cols-[minmax(0,1.6fr)_minmax(0,1fr)]">
          <div className="space-y-6">
            <div className="rounded-3xl border border-line bg-panel/70 backdrop-blur">
              <div className="flex items-center justify-between border-b border-line bg-[#0e1629] px-5 py-4">
                <div className="flex items-center gap-2.5">
                  <span className="grid h-9 w-9 place-items-center rounded-lg bg-rose-500/15 text-rose-400 ring-1 ring-rose-500/30">
                    <LifeBuoy size={17} />
                  ...
                  {selected.status === "Resolved" ? (
                    ...
                    <>
                      ...
                      <button
                        ...
                        className="group flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-red-500 via-rose-600 to-red-800 px-5 py-3 text-sm font-bold text-obsidian transition-all disabled:cursor-not-allowed disabled:opacity-40"
                      >
                        <Send size={15} />
              ...
              <div className="space-y-4 p-5">
                ...
                <div className="mt-2 rounded-xl border border-rose-500/20 bg-rose-500/5 p-4">
                  ...
                  <button
                    ...
                    className="mt-3 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-red-500 via-rose-600 to-red-800 px-5 py-3 text-sm font-bold text-obsidian transition-all"
                  >
                    <Plus size={15} />
        ...
        {inspect && (
          ...
          >
            <motion.div
              ...
              onClick={(e) => e.stopPropagation()}
              className="relative w-full max-w-3xl overflow-hidden rounded-3xl border border-line bg-panel"
            >
              <div className="flex items-center justify-between border-b border-line bg-[#0e1629] px-5 py-4">
                <div className="flex items-center gap-2.5">
                  <span className="grid h-9 w-9 place-items-center rounded-lg bg-rose-500/15 text-rose-400 ring-1 ring-rose-500/30">
      ...
      <AnimatePresence>
        {savedFlash && (
          <motion.div
            ...
            transition={{ duration: 0.25 }}
            className="fixed bottom-6 right-6 z-[90] max-w-sm border border-emerald-500/40 bg-panel/95 p-4 backdrop-blur"
