...
function ResourceCard({ resource, onOpen }) {
  ...
  return (
    <motion.article
      ...
      className="group relative flex h-full cursor-pointer flex-col overflow-hidden rounded-2xl border border-line bg-panel transition-all duration-300 hover:-translate-y-1.5 hover:border-rose-500/50"
    >
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="flex w-full max-w-6xl flex-col overflow-hidden rounded-2xl border border-rose-500/30 bg-[#0a1122]"
      >
        <div className="flex items-center gap-2 border-b border-line bg-panel/80 px-3 py-2.5 sm:px-4">
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <button
              type="button"
              onClick={onClose}
              className="inline-flex items-center gap-1.5 rounded-lg bg-gradient-to-r from-red-500 to-rose-700 px-3 py-1.5 font-mono text-xs font-bold text-obsidian transition-transform hover:scale-[1.03]"
            >
              <X size={13} />
              Close (ESC)
            </button>
        ...
        <div className="flex flex-1 flex-col overflow-hidden">
          ...
          <div className="relative flex-1 bg-[#0a1122]">
            <iframe
              key={resource.id}
              src={resource.url}
              ...
              return (
                <button
                  ...
                  className={`relative rounded-xl px-4 py-2.5 text-sm font-semibold transition-all ${
                    isActive
                      ? "bg-gradient-to-r from-red-500 via-rose-600 to-red-800 text-obsidian"
        ...
        {filtered.length > 0 ? (
          ...
          <div className="mt-12 flex flex-col items-center gap-4 rounded-2xl border border-dashed border-line bg-panel/50 px-8 py-14 text-center">
            ...
            <button
              ...
              className="mt-1 rounded-lg bg-gradient-to-r from-red-500 to-rose-700 px-5 py-2.5 text-sm font-semibold text-obsidian"
            >
              Show All Ecosystems
            </button>
          </div>
