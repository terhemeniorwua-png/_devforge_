...
export default function Footer() {
  ...
  return (
    <footer className="relative mt-auto overflow-hidden border-t border-line bg-[#000000]">
      ...
      <div className="pointer-events-none absolute -top-40 left-1/2 h-80 w-[560px] -translate-x-1/2 rounded-full radial-crimson blur-xl" />
          ...
          <div>
            ...
            <div className="mt-8 max-w-sm">
              ...
              >
                ...
                <button
                  type="submit"
                  className="group inline-flex shrink-0 items-center gap-1.5 rounded-lg bg-gradient-to-r from-red-500 to-rose-700 px-4 py-2.5 text-sm font-semibold text-obsidian transition-all"
                >
                  Join
